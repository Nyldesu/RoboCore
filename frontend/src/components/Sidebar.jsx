      ...
      <aside className="h-screen z-99">
          <nav className="h-full flex flex-col bg-white  shadow-sm">
            <div className="p-5 pb-2 flex justify-between items-center">
              <img src = {robocoreLogo} className={` overflow-hidden transition-all
                ${expanded ? "w-30": "w-0"}`} alt=""/>
              <button
  ...
  return (
    <Link
      to={to}
      className={`group relative flex items-center py-2 px-4 my-1 font-medium rounded-md 
        transition-colors cursor-pointer
        ${active
          ? "bg-[#9ACBD0] from-indigo-200 to-indigo-100 text-[#006A71]"
