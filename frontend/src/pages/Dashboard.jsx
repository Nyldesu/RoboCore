...
export default function Dashboard() {
  ...
  // ✅ Update attendance list after a scan
    ...
    <div className="p-4">
      ...
      {activeTab === "event" && (
        <div className="p-6 bg-white rounded-lg shadow-md max-w-3xl mx-auto">
          <h1 className="text-2xl font-bold mb-2 text-[#006A71]">
            Create Event
          </h1>
          ...
          <form className="space-y-4">
            ...
            <textarea
              ...
              className="w-full h-32 border border-gray-300 rounded px-4 py-2 focus:ring-2 focus:ring-indigo-400"
            ></textarea>
